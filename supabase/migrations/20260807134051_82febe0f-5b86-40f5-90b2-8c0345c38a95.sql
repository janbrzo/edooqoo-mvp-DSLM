...
DECLARE
  ...
  teacher_only text[] := ARRAY[
    ...
    'compute_skill_metric','consume_token','get_token_balance','create_mcp_token','revoke_mcp_token',
    'find_student_by_email','get_student_tags','get_worksheet_live_answers','generate_flashcard_share_token',
...
BEGIN
  ...
  LOOP
    ...
    IF r.proname = ANY(teacher_only) THEN
