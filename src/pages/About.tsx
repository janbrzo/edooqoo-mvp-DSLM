        ...
        <section className="mb-12">
          ...
          <div className="space-y-8">
            {[
              ...
              { icon: GraduationCap, title: 'Welcome Placement Test', desc: 'A 49-question CEFR-oriented diagnostic covering grammar, vocabulary, reading, listening, and speaking. Results become profile input and a DSLM starting point for teacher review.', bullets: ['49 questions across 5 skill categories', 'AI-analyzed Learning Profile', 'Skill scores and confidence signals', 'CEFR level estimation with confidence score'] },
