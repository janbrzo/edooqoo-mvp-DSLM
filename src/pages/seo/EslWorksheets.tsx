...
const collectionLd = {
  ...
  description: 'AI-generated, fully personalized ESL worksheets for adult learners across CEFR A1-C2, with 29 exercise types and AI-assisted homework review.',
...
const EslWorksheets = () => (
  <SeoLandingLayout
    ...
    solutions={[
      { title: 'Structured worksheet output', body: 'Type the topic, pick CEFR level, choose exercise types. Edooqoo generates a full worksheet draft with instructions, examples, and answer keys.' },
    ...
    listIntro="Every type below is one of the 29 exercise types in Edooqoo. Each is editable after generation and can be assigned as homework with AI-assisted review."
    list={[
      ...
      { title: 'Email writing with model answer', body: 'Brief + model email + grading rubric. Open answers can use AI-assisted evaluation when assigned as homework.', href: '/exercise-types' },
    ...
    body={
      <>
        ...
        <p>Every worksheet generation can use four data points: CEFR level, lesson topic, grammar focus, and the student's Learning Profile. The Learning Profile is built from the 49-question <Link to="/features/placement-test" className="text-primary hover:underline">Welcome Test</Link>, ongoing exercise results, and teacher notes. DSLM organizes available context so the worksheet output can align with the next teacher-approved focus — see <Link to="/features/dslm" className="text-primary hover:underline">DSLM</Link>.</p>
        <p>After generation, every worksheet has a permanent shareable link. Send it to the student before the lesson, use it live on screen-share, or assign specific exercises as homework with deadlines. Objective tasks can be auto-checked. Open-answer exercises can use AI-assisted evaluation for teacher review and adjustment.</p>
        <h2 className="text-xl font-bold text-foreground">Pricing for ESL worksheet generation</h2>
        <p>The Free plan includes 2 worksheets and unlimited students — enough to test the generator with one student. Side-Gig ($9/month) gives 15 worksheets per month, suitable for a tutor with 5-10 weekly students. Full-Time (from $19/month) gives 30-90 worksheets per month for full-time teachers. Every plan includes all 29 exercise types, AI-assisted homework review, flashcards with SM-2 spaced repetition, and the Student Hub portal. See full <Link to="/pricing" className="text-primary hover:underline">pricing</Link>.</p>
      </>
    }
    faqs={[
