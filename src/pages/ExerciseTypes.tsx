...
const exerciseTypes = [
  { category: "Basic Exercises", types: [
    ...
    { name: "Answer Questions", description: "Open-ended questions requiring full sentence answers. Tests both comprehension and productive language ability. AI-assisted evaluation can support teacher review.", bestFor: "A2-C2", useCase: "Testing comprehension depth, developing written production, Cambridge exam practice." },
    { name: "Discussion Questions", description: "Thought-provoking questions for speaking or writing practice. AI-assisted review can support feedback on relevance, coherence, grammar, and vocabulary.", bestFor: "B1-C2", useCase: "Speaking preparation, critical thinking, essay writing practice, debate skills." },
    ...
    { name: "Paraphrasing", description: "Rewrite sentences keeping the same meaning using different words. AI-assisted review can support feedback on meaning preservation, grammar, and vocabulary range.", bestFor: "B1-C2", useCase: "Writing skills, vocabulary flexibility, Cambridge exam preparation." },
    { name: "Sentence Transformation", description: "Transform sentences using specific grammar structures (e.g., active→passive, direct→reported speech). AI-assisted review can support accuracy checks.", bestFor: "B1-C2", useCase: "Grammar mastery, Use of English practice, structural flexibility." },
  ...
  { category: "Audio Exercises", types: [
    ...
    { name: "Answer Questions (Audio)", description: "Listen to audio and write open-ended answers. AI-assisted review can support feedback on response quality and relevance.", bestFor: "A2-C2", useCase: "Advanced listening skills, note-taking, integrated skills practice." },
  ]},
  { category: "Picture Exercises", types: [
    { name: "Describe Picture", description: "Write a description of an AI-generated image. AI-assisted review can support feedback on accuracy, detail, vocabulary range, and grammar.", bestFor: "A2-C2", useCase: "Speaking exam preparation, descriptive writing, vocabulary activation." },
    ...
    { name: "Answer Questions (Picture)", description: "Look at an image and answer open-ended questions about it. AI-assisted review can support teacher feedback.", bestFor: "A2-C2", useCase: "Speaking preparation, inference skills, creative language use." },
  ]},
];
