...
const glossaryTerms = [
  ...
  { term: "Paraphrasing", definition: "Restating ideas using different words while keeping the same meaning. An AI-assisted exercise type in Edooqoo that develops productive vocabulary skills with teacher review." },
  ...
  { term: "Multiple Choice", definition: "Selecting the correct answer from several options. Edooqoo offers text, audio, and picture-based MCQ variants with objective auto-checking." },
  ...
  { term: "Discussion Questions", definition: "Open-ended questions requiring extended responses. An AI-assisted exercise type in Edooqoo for developing speaking and writing fluency with teacher review." },
  { term: "Describe Picture", definition: "Writing about an image, describing what you see and inferring meaning. An AI-assisted picture exercise in Edooqoo with teacher review." },
