...
const HeroHeadline: React.FC<HeroHeadlineProps> = ({
  ...
  return (
    <section className="relative px-4 pt-10 pb-8 sm:pt-12 lg:pt-16 lg:pb-10 overflow-hidden">
      ...
      <div className="w-full min-w-0 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(340px,420px)] gap-8 lg:gap-10 items-center">
        <div className="min-w-0 max-w-full text-center lg:text-left">
          {/* Headline */}
          <h1 className="max-w-full break-words text-[2rem] sm:text-5xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground mb-5 leading-[1.1]">
          ...
          <p
            className="max-w-full text-lg sm:text-xl text-muted-foreground mb-6 sm:max-w-2xl mx-auto lg:mx-0 leading-relaxed"
          ...
          <p className="max-w-full text-sm sm:text-base text-foreground/80 mb-8 sm:max-w-2xl mx-auto lg:mx-0 font-medium">
          ...
          <div className="w-full max-w-full sm:max-w-2xl mx-auto lg:mx-0 overflow-hidden border border-border rounded-2xl bg-secondary/60 py-[10px] my-[15px]">
            <p className="text-xs font-semibold tracking-wide text-center mb-1.5 px-4 text-muted-foreground">
