...
const HeroHeadline: React.FC<HeroHeadlineProps> = ({
  ...
  return (
    <section className="relative px-4 pt-12 pb-14 sm:pt-16 lg:pt-20 lg:pb-24 overflow-hidden">
      ...
      <div className="w-full min-w-0 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(360px,460px)] gap-10 lg:gap-14 items-start">
        <div className="min-w-0 max-w-full text-center lg:text-left">
          ...
          <h1 className="max-w-full break-words text-[2.25rem] sm:text-5xl md:text-6xl lg:text-6xl xl:text-[4.25rem] font-extrabold tracking-tight text-foreground mb-7 leading-[1.18]">
          ...
          <p
            className="max-w-full text-lg sm:text-xl lg:text-[1.375rem] text-muted-foreground mb-7 sm:max-w-2xl lg:max-w-[34rem] mx-auto lg:mx-0 leading-relaxed"
          ...
          {/* CTA Area */}
          <div className="flex max-w-full flex-col items-center lg:items-start gap-4 mb-7">
            <div className="flex w-full max-w-full flex-col sm:w-auto sm:flex-row gap-3">
              <Button
                onClick={handlePrimaryCta}
                size="lg"
                className="h-[3.25rem] sm:h-16 w-full sm:w-auto justify-center px-5 sm:px-8 text-base sm:text-xl max-w-full whitespace-normal sm:whitespace-nowrap font-semibold rounded-full shadow-lg shadow-violet-500/20 hover:shadow-violet-500/30 hover:-translate-y-0.5 transition-all duration-200">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-[3.25rem] sm:h-16 w-full sm:w-auto justify-center px-5 sm:px-7 text-base sm:text-lg font-semibold rounded-full bg-white/90"
              >
                Try worksheet generator now
                <ArrowDown className="ml-2 h-4 w-4" />
              </Button>
            </div>
            <div className="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-2 text-sm sm:text-base text-muted-foreground">
            ...
            <p className="max-w-full text-sm text-muted-foreground sm:max-w-2xl">
