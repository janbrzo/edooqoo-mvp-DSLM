...
async function main() {
  ...
  const markdown = [
    ...
    '|---|---:|---:|---|',
    statusLine('Live routing failed checks', live?.totals?.failed ?? 'not run', 0, live ? rel(path.join(ROOT, 'docs', 'seo', 'live-routing.generated.md')) : 'Run npm run seo:verify-live-routing -- --soft'),
